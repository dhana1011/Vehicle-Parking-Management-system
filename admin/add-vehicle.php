...
if(isset($_POST['submit']))
  {
    $parkingnumber = mt_rand(100000000, 999999999);
        ...
        // Set default value of registration number based on category
        $vehreno = ($catename == "Bicycles") ? '0' : $_POST['vehreno'];

        $query = mysqli_query($con, "insert into  tblvehicle(ParkingNumber,VehicleCategory,VehicleCompanyname,RegistrationNumber,OwnerName,OwnerContactNumber,Status) 
    value('$parkingnumber','$catename','$vehcomp','$vehreno','$ownername','$ownercontno','IN')");
        if ($query) {
...
<head>
    <script>
        ...
        function changestatus() {
            var status = document.getElementById("catename");
            var regNumberField = document.getElementById("vehreno");
            if (status.value == "bicycle") {
                regNumberField.style.visibility = "hidden";
                regNumberField.value = 0; // Set default value to 0
            } else {
                regNumberField.style.visibility = "visible";
            }
        }

        function validateContactNumber(input) {
    // Remove any non-numeric characters
    var contactNumber = input.value.replace(/\D/g, '');
    
    // Check if the contact number contains exactly 10 digits
    if (contactNumber.length !== 10) {
        // If not, show an error message
        input.setCustomValidity("Contact number must contain exactly 10 digits.");
    } else {
        // If it contains 10 digits, clear any error message
            ...
            <div class="animated fadeIn">
                                ...
                                <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9">
                                            <select name="catename" id="catename" onchange="changestatus()" class="form-control">
              ...
              ?>    
                  ...
                  <?php } ?> 
                                    ...
                                    <div class="col-12 col-md-9"><input type="text" id="ownercontno" name="ownercontno" class="form-control" placeholder="Owner Contact Number" required="true" maxlength="10" pattern="[0-9]+" oninput="validateContactNumber(this)"></div>
